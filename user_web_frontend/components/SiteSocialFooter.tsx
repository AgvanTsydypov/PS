...
const SOCIAL_ITEMS: SocialItem[] = [
  ...
  },
  {
    key: "opensea",
    label: "OpenSea",
    href: "https://opensea.io/collection/polystars",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" fill="currentColor" fillRule="evenodd" aria-hidden="true" focusable="false">
        <path d="M 15.131 0 C 6.743 -0.067 -0.069 6.744 0.001 15.132 C 0.07 23.276 6.725 29.931 14.869 30 c 8.388 0.072 15.202 -6.742 15.13 -15.13 C 29.932 6.727 23.276 0.07 15.131 0 Z M 14.978 4.634 c 0.537 0 0.972 0.435 0.972 0.972 v 1.248 c 2.982 1.392 4.935 3.702 4.935 6.315 c 0 1.533 -0.67 2.96 -1.827 4.16 c -0.222 0.23 -0.53 0.36 -0.852 0.36 h -2.254 v 1.857 h 2.83 c 0.61 0 1.706 -1.158 2.225 -1.856 c 0 0 0.022 -0.034 0.082 -0.052 c 0.06 -0.018 5.198 -1.197 5.198 -1.197 a 0.17 0.17 0 0 1 0.214 0.162 v 1.081 c 0 0.07 -0.037 0.13 -0.102 0.158 c -0.352 0.15 -1.515 0.69 -2 1.362 c -1.247 1.737 -2.2 4.467 -4.33 4.467 h -8.887 c -3.147 0 -5.78 -2.498 -5.778 -5.825 c 0 -0.082 0.07 -0.15 0.153 -0.15 h 4.212 c 0.145 0 0.26 0.117 0.26 0.26 v 0.813 c 0 0.432 0.349 0.783 0.782 0.783 h 3.195 v -1.86 h -2.182 a 9.293 9.293 0 0 0 2.002 -5.783 c 0 -2.437 -0.934 -4.66 -2.464 -6.322 c 0.925 0.108 1.81 0.292 2.644 0.537 v -0.518 c 0 -0.537 0.435 -0.972 0.972 -0.972 Z m -4.333 2.83 a 7.154 7.154 0 0 1 1.536 4.44 c 0 1.45 -0.43 2.8 -1.17 3.926 h -5.2 l 4.834 -8.365 Z" />
      </svg>
    ),
  },
];
