...
class Agent1QuantCardGenerator:
    ...
    def build_prompt_context(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        prompt = (
            ...
            f"- tags: {tags}\n\n"
            "Hard rules:\n"
            "- card_title: max 6 words, no question mark, no trailing ellipsis. Title must suit naming for trading collectible card. Specify date where possible in short form for month and year.\n"
