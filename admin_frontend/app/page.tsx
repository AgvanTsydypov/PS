    ...
    <main>
      ...
      {tab === "claims" ? (
        <ClaimsMint
          ...
          claimSeasonId={claimSeasonId}
          claimWallet={claimWallet}
          wallets={wallets}
          walletFilter={walletFilter}
          walletsLoading={walletsLoading}
          onSeasonIdChange={setClaimSeasonId}
          onWalletChange={setClaimWallet}
          onWalletFilterChange={setWalletFilter}
          run={run}
          refreshSeasonClaims={refreshSeasonClaims}
      ...
      {tab === "reset" ? (
        <section className="panel">
          <div className="muted">
            ...
            and preview_cards (with RESTART IDENTITY). Any legacy global
